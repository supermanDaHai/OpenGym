...
const P = {
  ...
  alert: <><path d="M12 4.6 20.6 19.4H3.4Z" /><path d="M12 9.8v4.4" /><path d="M12 17h.01" /></>,
  eye: <><path d="M3.6 12c2.4-3.4 5.2-5.1 8.4-5.1s6 1.7 8.4 5.1c-2.4 3.4-5.2 5.1-8.4 5.1s-6-1.7-8.4-5.1Z" /><circle cx="12" cy="12" r="2.7" /></>,
  eyeOff: <><path d="M3.6 12c2.4-3.4 5.2-5.1 8.4-5.1s6 1.7 8.4 5.1c-2.4 3.4-5.2 5.1-8.4 5.1s-6-1.7-8.4-5.1Z" /><path d="M12 9.4a2.6 2.6 0 0 1 2.6 2.6" /><path d="m4.4 4.4 15.2 15.2" /></>,
